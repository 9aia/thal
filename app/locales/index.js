/* eslint-disable */ export default {
  ...
  "Uh-oh... something went wrong on our end. It might be a temporary glitch, or the server’s just having a rough day. Please try again later.": {
    "pt": "Ops... algo deu errado do nosso lado. Pode ser uma falha temporária ou o servidor está tendo um dia ruim. Tente novamente mais tarde."
  },
  "If the problem persists, {reportIssue}. We’ll check it out and get things back on track.": {
    "pt": "Se o problema persistir, {reportIssue}. Vamos verificar e colocar as coisas de volta nos trilhos."
  },
  "let us know here": {
    "pt": "avise-nos aqui"
  },
  ...
  "Username is required": {
    "pt": "Nome de usuário é obrigatório"
  },
  "Username does not match": {
    "pt": "Nome de usuário não corresponde"
  },
  "Are you sure?": {
    "pt": "Você tem certeza?"
  },
  ...
  "Create a custom character that matches your specific goals in learning English.": {
    "pt": "Crie um personagem personalizado que corresponda aos seus objetivos específicos no aprendizado de inglês."
  },
  "You have no characters yet.": {
    "pt": "Você ainda não tem personagens."
  },
  "Create character": {
    "pt": "Criar personagem"
  },
  ...
  "Search name or username...": {
    "pt": "Pesquisar nome ou nome de usuário..."
  },
  "Discover": {
    "pt": "Descobrir"
  },
  ...
  "This name will be passed to the characters.": {
    "pt": "Este nome será passado para os personagens."
  },
  "Username": {
    "pt": "Nome de usuário"
  },
  ...
  "An error occurred while validating username.": {
    "pt": "Ocorreu um erro ao validar o nome de usuário."
  },
  "An error occurred while editing contact.": {
    "pt": "Ocorreu um erro ao editar o contato."
  },
  "An error occurred while creating contact.": {
    "pt": "Ocorreu um erro ao criar o contato."
  },
  "{name} was added to your contacts.": {
    "pt": "{name} foi adicionado aos seus contatos."
  },
  "{name} was edited.": {
    "pt": "{name} foi editado."
  },
  ...
  "Chat with AI-powered characters anytime, anywhere.": {
    "pt": "Converse com personagens com tecnologia de IA a qualquer hora, em qualquer lugar."
  },
  ...
  "Create, discover and save characters for tailored learning.": {
    "pt": "Crie, descubra e salve personagens para aprendizado personalizado."
  },
  "Your account has been deactivated.": {
    "pt": "Sua conta foi desativada."
  },
  "We are sorry to see you go. If you change your mind, you can always login to recover your account.": {
    "pt": "Sentimos muito vê-lo partir. Se mudar de ideia, você sempre pode fazer login para recuperar sua conta."
  },
  "Go to home": {
    "pt": "Ir para a página inicial"
  },
  ...
  "Just describe their personality and behavior in a short prompt — our AI will instantly bring them to life in seconds, ready for dynamic and engaging conversations.": {
    "pt": "Basta descrever sua personalidade e comportamento em um prompt curto — nossa IA os trará instantaneamente à vida em segundos, pronta para conversas dinâmicas e envolventes."
  },
  ...
  "Clipboard API is not available": {
    "pt": "API da área de transferência não está disponível"
  },
  ...
  "An error occurred while logging out.": {
    "pt": "Ocorreu um erro ao sair."
  },
  "Travel, Tourism & Transportation": {
    "pt": "Viagens, Turismo e Transporte"
  },
  "Practice conversations for traveling abroad, including booking accommodations, asking for directions, and more.": {
    "pt": "Pratique conversas para viagens ao exterior, incluindo reserva de acomodações, pedidos de informações e muito mais."
  },
  "Shopping & Retail": {
    "pt": "Compras e Varejo"
  },
  "Characters in a retail setting, such as shopping for clothes, groceries, or electronics, designed to practice consumer interactions.": {
    "pt": "Personagens em um ambiente de varejo, como compras de roupas, alimentos ou eletrônicos, projetados para praticar interações com o consumidor."
  },
  "Food & Beverage": {
  ...
  "Education & Learning": {
    "pt": "Educação e Aprendizagem"
  },
  "Simulate discussions in educational settings, from classroom dialogues to study groups.": {
    "pt": "Simule discussões em ambientes educacionais, de diálogos em sala de aula a grupos de estudo."
  },
  "Health & Wellness": {
    "pt": "Saúde e Bem-Estar"
  },
  "Characters that discuss health, fitness, mental well-being, and lifestyle topics.": {
    "pt": "Personagens que discutem saúde, condicionamento físico, bem-estar mental e tópicos relacionados ao estilo de vida."
  },
  "Technology & Engineering": {
    "pt": "Tecnologia e Engenharia"
  },
  "Characters discussing tech trends, engineering concepts, and digital innovations.": {
    "pt": "Personagens discutindo tendências tecnológicas, conceitos de engenharia e inovações digitais."
  },
  "Business & Career": {
    "pt": "Negócios e Carreira"
  },
  ...
  "Focused on family dynamics, parenting, and relationships between relatives.": {
    "pt": "Focado na dinâmica familiar, na parentalidade e nos relacionamentos entre parentes."
  },
  "Law & Justice": {
    "pt": "Lei e Justiça"
  },
  ...
  "Characters discussing religious beliefs, spiritual practices, and philosophical topics.": {
    "pt": "Personagens discutindo crenças religiosas, práticas espirituais e tópicos filosóficos."
  },
  "Sports & recreation": {
  ...
  "Hotel & Lodging": {
    "pt": "Hotel e Alojamento"
  },
  "Characters for practicing conversations in hotels, hostels, and other lodging situations.": {
    "pt": "Personagens para praticar conversas em hotéis, albergues e outras situações de alojamento."
  },
  ...
  "Characters discussing current events, news stories, and media topics.": {
    "pt": "Personagens discutindo eventos atuais, notícias e tópicos de mídia."
  },
  ...
  "Hmm... we couldn't find that route. It might have been moved, renamed, or never existed at all. Please check the URL for typos.": {
    "pt": "Hmm... não conseguimos encontrar essa rota. Ela pode ter sido movida, renomeada ou nunca ter existido. Por favor, verifique se há erros de digitação na URL."
  },
  "That username's taken — tweak your prompt or suggest one directly.": {
    "pt": "Esse nome de usuário já está em uso — ajuste seu pedido ou sugira um diretamente."
  },
  ...
  "This is A.I. and not a real person. Treat everything it says as fiction. What is said should not be relied upon as fact or advice.": {
    "pt": "Isto é IA e não uma pessoa real. Trate tudo o que ela diz como ficção. O que é dito não deve ser considerado como fato ou conselho."
  },
  "Delete": {
    "pt": "Excluir"
  }
