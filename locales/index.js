/* eslint-disable */ export default {
  ...
  "Thal allows you to tailor your preferences to suit your needs, whether you prefer to navigate in your native language or challenge yourself with English.": {
    "pt": "O Thal permite que você personalize suas preferências para atender às suas necessidades, seja você prefere navegar no seu idioma nativo ou se desafiar com o inglês."
  },
  "All categories": {
  ...
  "Username does not match": {
    "pt": "Os nomes de utilizador não coincidem"
  },
  "Are you sure?": {
    "pt": "Tem certeza?"
  },
  "Delete character": {
    "pt": "Apagar personagem"
  },
  "Deactivate Account": {
    "pt": "Desativar conta"
  },
  "Deactivate my account": {
    "pt": "Desativar a minha conta"
  },
  "What's New": {
    "pt": "Novidades"
  },
  ...
  "We are sorry to see you go. If you change your mind, you can always login to recover your account.": {
    "pt": "Lamentamos vê-lo partir. Se mudar de ideia, você sempre pode fazer login para recuperar sua conta."
  },
  "Go to home": {
    "pt": "Ir para casa"
  },
  ...
  "Interactive Language Assistance": {
    "pt": "Assistência de idioma interativa"
  },
  "Discover Characters": {
  ...
  "Your subscription is being processed yet.": {
    "pt": "Sua assinatura está sendo processada."
  },
  ...
  "You will receive access to the app as soon as possible.": {
    "pt": "Você receberá acesso ao aplicativo assim que possível."
  },
  "Try access": {
    "pt": "Tentar acesso"
  },
  ...
  "This character uses AI to simulate interactions. Please use responsibly.": {
    "pt": "Este personagem usa IA para simular interações. Por favor, use com responsabilidade."
  },
  "Not a contact": {
    "pt": "Não é um contato"
  },
  ...
  "Personal data has been updated successfully.": {
    "pt": "Dados pessoais atualizados com sucesso."
  },
  ...
  "Create a custom character that matches your specific goals in learning English.": {
    "pt": "Crie um personagem personalizado que corresponda aos seus objetivos específicos de aprendizado de inglês."
  },
  "Discover characters": {
    "pt": "Descobrir personagens"
  },
