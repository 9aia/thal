...
import type { TimelineItem } from '#lib/daisy/components/display/types'
...
function getTimelineItems(nodes: Node[], i = 0) {
...
<template>
  ...
  <section v-for="section in course.sections" :key="section.id">
