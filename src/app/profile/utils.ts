...
export const INTERESTS = [
  ...
  { id: "shooting_sports", icon: "sports", name: "Shooting Sports" },
  { id: "basketball", icon: "sports_basketball", name: "Basketball" },
  { id: "sumo_wrestling", icon: "sports", name: "Sumo wrestling" },
  ...
  { id: "badminton", icon: "sports", name: "Badminton" },
  { id: "basque_pelota", icon: "sports", name: "Basque pelota" },
  { id: "billiards", icon: "sports", name: "Billiards" },
  { id: "bobsledding", icon: "sports", name: "Bobsledding" },
  ...
  { id: "canoeing", icon: "sports", name: "Canoeing" },
  ...
  { id: "poker", icon: "sports", name: "Poker" },
  { id: "polo", icon: "sports", name: "Polo" },
  { id: "racquetball", icon: "sports", name: "Racquetball" },
  ...
  { id: "table_tennis", icon: "sports", name: "Table tennis" },
  { id: "taekwondo", icon: "sports", name: "Taekwondo" },
  ...
  { id: "wrestling", icon: "sports", name: "Wrestling" },
