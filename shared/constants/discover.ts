...
export const categories = ([
  {
    ...
    description: t('Practice conversations for traveling abroad, including booking accommodations, asking for directions, and more.'),
  ...
  },
  {
    ...
    description: t('Characters in a retail setting, such as shopping for clothes, groceries, or electronics, designed to practice consumer interactions.'),
  ...
  },
  {
    ...
    description: t('Characters for practicing conversations in restaurants, cafes, and food-related situations like menu ordering, dietary preferences, and cooking.'),
  ...
  },
  {
    ...
    description: t('Characters discussing scientific topics, nature, and environmental issues.'),
  ...
  },
  {
    ...
    description: t('Characters for practicing conversations related to dating, relationships, and social interactions.'),
  ...
  },
  {
    ...
    description: t('Simulate discussions in educational settings, from classroom dialogues to study groups.'),
  ...
  },
  {
    ...
    description: t('Characters that discuss health, fitness, mental well-being, and lifestyle topics.'),
  ...
  },
  {
    ...
    description: t('Characters discussing tech trends, engineering concepts, and digital innovations.'),
  ...
  },
  {
    ...
    description: t('Focused on professional settings, such as meetings, emails, and workplace interactions.'),
  ...
  },
  {
    ...
    description: t('Focused on family dynamics, parenting, and relationships between relatives.'),
  ...
  },
  {
    ...
    description: t('Characters discussing legal matters, court cases, and justice-related topics.'),
  ...
  },
  {
    ...
    icon: 'material-symbols:church-outline-rounded',
    description: t('Characters discussing religious beliefs, spiritual practices, and philosophical topics.'),
  ...
  },
  {
    ...
    description: t('Characters discussing sports, fitness, and recreational activities.'),
  ...
  },
  {
    ...
    description: t('Characters for practicing conversations in hotels, hostels, and other lodging situations.'),
  ...
  },
  {
    ...
    description: t('Characters related to the entertainment industry, including actors, comedians, and performers.'),
  ...
  },
  {
    ...
    description: t('Characters for practicing conversations in real estate, including buying, selling, or renting properties.'),
  ...
  },
  {
    ...
    description: t('Characters related to art, design, and creative fields.'),
  ...
  },
  {
    ...
    description: t('Characters for casual conversations about everyday life, hobbies, and interests.'),
  ...
  },
  {
    ...
    description: t('Characters discussing current events, news stories, and media topics.'),
  ...
  },
  {
    ...
    description: t('Characters that don\'t fit into other categories.'),
