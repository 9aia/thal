/* eslint-disable */
// Generated by Wrangler by running `wrangler types server/worker-configuration.d.ts` (hash: fc5c6fe9a346fa8bced20020b7b7dc3d)
// Runtime types generated with workerd@1.20250617.0 2025-09-17 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		ANALYSIS_RATE_LIMIT: RateLimit;
		CORRECTION_RATE_LIMIT: RateLimit;
		ANALYSIS_EXPLANATION_RATE_LIMIT: RateLimit;
		ASSETS: Fetcher;
	}
}
